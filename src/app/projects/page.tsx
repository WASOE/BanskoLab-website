...
export const metadata: Metadata = {
  title: "Projects",
  description:
    "Explore our portfolio: village transformation, field-site programmes, learning initiatives and digital systems. Each project includes goals, status and outcomes.",
};
